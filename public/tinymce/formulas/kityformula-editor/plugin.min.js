...
tinymce.PluginManager.add('kityformula-editor', function(editor, url) {
    ...
    // var baseURL = process.env.VITE_APP_BASE_API.editorUrl +'/plugins/kityformula-editor/kityFormula.html';

    // var baseURL = process.env.VUE.env.VUE_APP_PUBLIC_PATH + 'tinymce/formulas/kityFormula.html';
