<template>
  <div class="school-management">
    ...
    >
      ...
      <el-table-column prop="city" label="所在地市" min-width="120" align="center">
        <template #default="{ row }"> 
...
const getSchoolSystem = (schoolSystem) => {
  return mt_base_education_type.value ?.find(item => item.value === schoolSystem.toString()).label
}
...
const handleAdd = () => {
  router.push({
    path: '/glxt/base_school/add_base_school',
    query: {
      type: 'add'
    }
  })
