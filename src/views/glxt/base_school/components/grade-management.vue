    ...
    <div class="content-wrapper">
      ...
      <div class="table-card">
        <div class="table-header">
          ...
          <el-button type="primary" plain @click="clickAddHandle" v-hasPermi="['glxt:grade:add']">
        ...
        <el-table :data="gradeList"  style="width: 100%">
          ...
          <el-table-column label="操作" width="200" align="center">
            <template #default="scope">
              <el-button type="primary" link @click="editGrade(scope.row)" v-hasPermi="['glxt:grade:edit']">
                <el-icon><Edit /></el-icon>编辑
              </el-button>
              <el-button type="danger" link @click="deleteGrade(scope.row)" v-hasPermi="['glxt:grade:remove']">
...
const reset = () => {
  geadeFrom.value = {
    ...
    schoolType: props.schoolInfo.schoolType
  }
  proxy.resetForm("gradeFormRef");
}
