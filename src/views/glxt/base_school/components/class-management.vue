      ...
      <div class="table-card">
        <div class="table-header">
          ...
          <div class="header-right">
            ...
            <el-button type="primary" plain @click="clickAddClass">
        ...
        <div class="table-container">
          <el-table :data="classList" v-loading="loading" style="width: 100%">
            ...
            <el-table-column prop="baseEduLevelType" label="入学时间" align="center"/>
            <el-table-column prop="name" label="班级名称" align="center"/>
            <el-table-column label="操作" width="200" align="center">
              <template #default="scope">
                <el-button type="primary" link @click="editClass(scope.row)" v-permission="['glxt:class:edit']">
                  <el-icon><Edit /></el-icon>编辑
                </el-button>
                <el-button type="danger" link @click="deleteClass(scope.row)" v-permission="['glxt:class:remove']">
    ...
    >
      <el-form :model="classForm" label-width="80px" :rules="rules" ref="classFormRef">
        <el-form-item label="年级" prop="gradeId">
          <el-select v-model="classForm.gradeId" placeholder="请选择年级" class="w-full" disabled>
            <el-option
              v-for="grade in grades"
              :key="grade.name"
              :label="grade.name"
        ...
        <el-form-item label="入学时间" prop="baseEduLevelType">
          <el-date-picker
            class="w-full"
            v-model="classForm.baseEduLevelType"
            type="year"
            placeholder="选择入学年份"
            format="YYYY"
            value-format="YYYY"
...
//引入班级api
import { listClass, addClass, updateClass, getClass , delClass, checkClass } from '@/api/glxt/base_class'
...
const handleCurrentChange = (val) => {
  ...
  // 这里可以调用获取数据的方法
  getClassesByGrade(currentGrade.value)
}
...
const handleGradeClick = (grade) => {
  ...
  setTimeout(() => {
    loading.close()
    ElMessage.success(`已切换到${grade.name}班级列表`)
  }, 500)
}
  ...
  // try{
    ...
    if (valid) {
      if (classForm.value.id != null) {
        updateClass(classForm.value).then(response => {
          if(response.code == 200){
        ...
        addClass(classForm.value).then(response => {
          if(response.code == 200){
